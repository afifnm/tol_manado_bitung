<div class="login-box">
	<div class="login-logo">
		<img src="<?php echo base_url('assets/upload/login.png'); ?>" width="300px">
<!-- 		<h3><a href="<?php echo base_url(); ?>"><?php echo $site['judul']?></a></h3> -->
	</div>
	<!-- /.login-logo -->
	<div class="login-box-body">
		...
		<form method="post" action="<?php echo base_url('auth/login'); ?>" role="login">
			...
			<div class="row">
				...
				<img src="<?php echo base_url('assets/upload/login2.png'); ?>" width="350px">
			</div>
		</form>

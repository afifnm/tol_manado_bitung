...
<form class="form-horizontal" method="post" action="<?php echo site_url('admin/request/simpan_tenaga');?>">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          <?php foreach ($tenaga as $tenaga) { $tenagaA++; ?>
            ...
            <div class="col-sm-6">
              <input type="hidden" name="id_detail_tenaga[<?php echo$tenagaA; ?>]" value="<?php echo$tenaga['id_detail_tenaga']; ?>">
              <input type="number" class="form-control" name="jumlah_tenaga[<?php echo$tenagaA; ?>]" style="margin:3px;" value="<?php echo$tenaga['jumlah']; ?>">
            </div>
          <?php } ?>
        </div>   
      </div>
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          <?php foreach ($material as $material) { $materialA++; ?>
            ...
            <div class="col-sm-6">
              <input type="hidden" name="id_detail_material[<?php echo$materialA; ?>]" value="<?php echo$material['id_detail_material']; ?>">
              <input type="number" class="form-control" name="jumlah_material[<?php echo$materialA; ?>]" style="margin:3px;" value="<?php echo$material['jumlah']; ?>">
            </div>
          <?php } ?>
        </div>   
      </div>
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        <?php foreach ($peralatan as $alat) { $peralatanA++; ?>
          ...
          <div class="col-sm-6">
            <input type="hidden" name="id_detail_peralatan[<?php echo$peralatanA; ?>]" value="<?php echo$alat['id_detail_peralatan']; ?>">
            <input type="number" class="form-control" name="jumlah_peralatan[<?php echo$peralatanA; ?>]" style="margin:2px;" value="<?php echo$alat['jumlah']; ?>">
          </div>
        <?php } ?>
      </div>   
    </div>

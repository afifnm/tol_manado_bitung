...
<div class="col-xs-3" align="left">
  <div class="box-header">
    <a data-toggle="modal" data-target="#ModalPlus" class="btn btn-danger btn-flat">Tambah Data Dokumen Metode Kerja  <i class="fa fa-plus-circle"></i></a>
  </div>
</div>
<div class="col-md-12">
  <div class="box box-solid">
    <div class="box-header">
      <h3 class="box-title" align="center">Data Dokumen Metode Kerja</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <table id="example1" class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <th style="text-align: center;">No. Metode</th>
          <th style="text-align: center;">Judul Metode</th>
        ...
        <tr>
        <td><?php echo $no; ?></td>
        <td><?php echo date_indo($u['tanggal_metode']); ?></td>
        <td><?php echo $u['no_metode']; ?></td>
        <td><?php echo $u['judul_metode']; ?></td>
        <td><?php echo $u['jumlah_halaman_metode']; ?></td>
        <td><?php echo $u['klasifikasi_metode']; ?></td>
        <td align="center">
          <a href="<?php echo $u['link_metode']; ?>" class="btn btn-info btn-xs" target="_blank"><i class="fa fa-link"> LINK METODE KERJA</i></a> 
          <a href="<?php echo site_url('admin/dokumen/edit_metode/'.$u['id_metode']);?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"> EDIT</i></a>  
          <button class="btn btn-danger btn-xs">  
          <?php echo anchor('admin/dokumen/delete_metode/'.$u['id_metode'], '<i style="color: white;" class="fa fa-trash"> HAPUS</i>', array('class'=>'delete', 'onclick'=>"return confirmDialog();")); ?>   
          </button>             
        </td>
        </tr>
        <?php $no++; } ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel" align="center">Tambah Data Dokumen Metode Kerja
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </h4>
        </div>
        <div class="box-body">
          <form class="form-horizontal" method="post" action="<?php echo site_url('admin/dokumen/simpan_metode');?>" enctype="multipart/form-data">
            <div class="box-body">
